...
public class Week6 extends HttpServlet
{
...
//    static String Servlet = "";
    ...
    // Location of servlet. remote
//    static String Domain  = "https://deval-parikh-swe432-week5.herokuapp.com/";
//    static String Path    = "week6";
//    static String Servlet = "";
    ...
    public Week6() throws UnknownHostException {
    }
    ...
    private void PrintBody (PrintWriter out, String lhs, String rhs, String rslt)
    {
        ...
        out.println("   <td><p name=\"RHS\" value=\"" + rslt + "\" size=6>" + rslt + "</p>");
        out.println("  </tr>");
        out.println(" </table>");
        out.println(" <br>");
        out.println(" <br>");
...
//        out.println(" <input type=\"reset\" value=\"Reset\" name=\"reset\">");
        out.println("</form>");
        out.println("<p>Source Code: <a href=\"https://github.com/devalparikh/Deval-SWE432-Week5\">https://github.com/devalparikh/Deval-SWE432-Week5</a></p>");
        out.println("");
        out.println("</body>");
    } // End PrintBody
